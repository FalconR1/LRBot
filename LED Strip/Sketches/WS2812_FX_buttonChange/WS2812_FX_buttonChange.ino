...
#define LED_COUNT 11          // число светодиодов в кольце/ленте
#define LED_DT 11             // пин, куда подключен DIN ленты

int max_bright = 100;          // максимальная яркость (0 - 255)
boolean adapt_light = 0;       // адаптивная подсветка (1 - включить, 0 - выключить)

byte fav_modes[] = {2, 11, 14, 26, 27, 30, 33};  // список "любимых" режимов
