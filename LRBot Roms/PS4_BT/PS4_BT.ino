...
void loop() {
  ...
  if (PS4.connected()) {
    ...
    if (PS4.getAnalogHat(LeftHatX) > 137) {
      speedL = map(PS4.getAnalogHat(LeftHatX), 138, 255, 91, 150); //Поворот направо
      ESC2.write(speedL);
      PS4.setLed(Yellow);
      ...
      if (PS4.getAnalogHat(LeftHatX) < 117) {
        speedR = map(PS4.getAnalogHat(LeftHatX), 0, 116, 150, 91); //Поворот налево
        ESC1.write(speedR);
        PS4.setLed(Yellow);
        PS4.setLedFlash(25, 25); 
      }
        ...
        if (PS4.getAnalogHat(RightHatX) > 137 || PS4.getAnalogHat(RightHatX) < 117) {
          speedR = map(PS4.getAnalogHat(RightHatX), 0, 255, 150, 30); //Развороты
          speedL = map(PS4.getAnalogHat(RightHatX), 0, 255, 30, 150);
          ESC1.write(speedR);
          ESC2.write(speedL);
          PS4.setLed(Yellow);
          ...
          if (PS4.getButtonPress(L1)) { //Поворот направо задний ход
            ESC2.write(30);
            PS4.setLed(White);
            PS4.setLedFlash(25, 25);
          }
          else {
            if (PS4.getButtonPress(R1)) { //Поворот налево задний ход
              ESC1.write(30);
              PS4.setLed(White);
              PS4.setLedFlash(25, 25);
            }
              ...
              if (PS4.getAnalogButton(L2)) {
                speedL = map(PS4.getAnalogButton(L2), 0, 255, 89, 30); //Задний ход
                ESC1.write(speedL);
                ESC2.write(speedL);
                PS4.setLed(Red);
                PS4.setLedFlash(25, 25);
                ...
                if (PS4.getAnalogButton(R2)) {
                  speedR = map(PS4.getAnalogButton(R2), 0, 255, 91, 150); //Движение вперед
                  ESC1.write(speedR);
                  ESC2.write(speedR);
                  PS4.setLed(Red);
                  PS4.setLedFlash(10, 10);
